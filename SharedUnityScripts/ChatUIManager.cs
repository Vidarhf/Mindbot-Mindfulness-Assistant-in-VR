...
public class ChatUIManager : MonoBehaviour {
    ...
    public bool debugConversationEnabled;
    private void Start()
    {
        ...
        if (debugConversationEnabled)
        {
            UpdateDisplay("user", "Lorem lorem lorem ipsum susdmdsidoasdnmk sidaiosdnmasn,mnqwe aiosdujamdnmaweq qweqwe qweqweqweqw q qweqeqweqweqweqweq qweqweqwe qweq eqweqeweqweqwe", "text");
            UpdateDisplay("bot", "this is a message", "text");
            UpdateDisplay("user", "short ", "text");
        }
    }
    ...
    public void UpdateDisplay (string sender, string message, string messageType) {
        ...
        //speechManager.SpeechPlayback(message); //TODO: move form here
    ...
    private void AddChatComponent (GameObject chatBubbleObject, string message, string messageType) {
        switch (messageType) {
            case "text":
                ...
                chatMessage.verticalOverflow = VerticalWrapMode.Truncate;
